...
import reducer, {
  ...
  reset,
  updateEntity,
} from './report-configuration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTCONFIGURATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REPORTCONFIGURATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REPORTCONFIGURATION actions', async () => {
      const arg = { id: 23981 };
    ...
    it('dispatches UPDATE_REPORTCONFIGURATION actions', async () => {
      const arg = { id: 23981 };
    ...
    it('dispatches PARTIAL_UPDATE_REPORTCONFIGURATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REPORTCONFIGURATION actions', async () => {
      const arg = 42666;
