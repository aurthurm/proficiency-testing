...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIPMENTSAMPLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SHIPMENTSAMPLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SHIPMENTSAMPLE actions', async () => {
      const arg = { id: 11542 };
    ...
    it('dispatches UPDATE_SHIPMENTSAMPLE actions', async () => {
      const arg = { id: 11542 };
    ...
    it('dispatches PARTIAL_UPDATE_SHIPMENTSAMPLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SHIPMENTSAMPLE actions', async () => {
      const arg = 42666;
