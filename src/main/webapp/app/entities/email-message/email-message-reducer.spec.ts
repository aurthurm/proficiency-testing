...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILMESSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMAILMESSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMAILMESSAGE actions', async () => {
      const arg = { id: 22744 };
    ...
    it('dispatches UPDATE_EMAILMESSAGE actions', async () => {
      const arg = { id: 22744 };
    ...
    it('dispatches PARTIAL_UPDATE_EMAILMESSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMAILMESSAGE actions', async () => {
      const arg = 42666;
