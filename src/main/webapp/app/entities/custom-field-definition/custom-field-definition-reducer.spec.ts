...
import reducer, {
  ...
  reset,
  updateEntity,
} from './custom-field-definition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMFIELDDEFINITION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMFIELDDEFINITION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMFIELDDEFINITION actions', async () => {
      const arg = { id: 27077 };
    ...
    it('dispatches UPDATE_CUSTOMFIELDDEFINITION actions', async () => {
      const arg = { id: 27077 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMFIELDDEFINITION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMFIELDDEFINITION actions', async () => {
      const arg = 42666;
