...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAPARECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CAPARECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CAPARECORD actions', async () => {
      const arg = { id: 3384 };
    ...
    it('dispatches UPDATE_CAPARECORD actions', async () => {
      const arg = { id: 3384 };
    ...
    it('dispatches PARTIAL_UPDATE_CAPARECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CAPARECORD actions', async () => {
      const arg = 42666;
