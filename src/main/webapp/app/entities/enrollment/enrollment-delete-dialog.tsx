...
export const EnrollmentDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      <ModalHeader data-cy="enrollmentDeleteDialogHeading" closeButton>
        <Translate contentKey="entity.delete.title">Confirm delete operation</Translate>
      </ModalHeader>
      <ModalBody id="proficiencyTestingApp.enrollment.delete.question">
        <Translate contentKey="proficiencyTestingApp.enrollment.delete.question" interpolate={{ id: enrollmentEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-enrollment" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
