...
import reducer, {
  ...
  reset,
  updateEntity,
} from './feedback-question.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKQUESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FEEDBACKQUESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FEEDBACKQUESTION actions', async () => {
      const arg = { id: 12017 };
    ...
    it('dispatches UPDATE_FEEDBACKQUESTION actions', async () => {
      const arg = { id: 12017 };
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKQUESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FEEDBACKQUESTION actions', async () => {
      const arg = 42666;
