...
export const AuditLogDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="proficiencyTestingApp.auditLog.delete.question">
        <Translate contentKey="proficiencyTestingApp.auditLog.delete.question" interpolate={{ id: auditLogEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-auditLog" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
