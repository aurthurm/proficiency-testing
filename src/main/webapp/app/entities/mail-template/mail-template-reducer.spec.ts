...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAILTEMPLATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MAILTEMPLATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MAILTEMPLATE actions', async () => {
      const arg = { id: 31230 };
    ...
    it('dispatches UPDATE_MAILTEMPLATE actions', async () => {
      const arg = { id: 31230 };
    ...
    it('dispatches PARTIAL_UPDATE_MAILTEMPLATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MAILTEMPLATE actions', async () => {
      const arg = 42666;
