...
import reducer, {
  ...
  reset,
  updateEntity,
} from './certificate-template.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CERTIFICATETEMPLATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CERTIFICATETEMPLATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CERTIFICATETEMPLATE actions', async () => {
      const arg = { id: 22807 };
    ...
    it('dispatches UPDATE_CERTIFICATETEMPLATE actions', async () => {
      const arg = { id: 22807 };
    ...
    it('dispatches PARTIAL_UPDATE_CERTIFICATETEMPLATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CERTIFICATETEMPLATE actions', async () => {
      const arg = 42666;
