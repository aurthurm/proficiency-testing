...
import reducer, {
  ...
  reset,
  updateEntity,
} from './participant-result.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICIPANTRESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARTICIPANTRESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARTICIPANTRESULT actions', async () => {
      const arg = { id: 15763 };
    ...
    it('dispatches UPDATE_PARTICIPANTRESULT actions', async () => {
      const arg = { id: 15763 };
    ...
    it('dispatches PARTIAL_UPDATE_PARTICIPANTRESULT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARTICIPANTRESULT actions', async () => {
      const arg = 42666;
