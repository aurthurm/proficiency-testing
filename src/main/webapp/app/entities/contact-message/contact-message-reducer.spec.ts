...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTMESSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTACTMESSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTACTMESSAGE actions', async () => {
      const arg = { id: 6827 };
    ...
    it('dispatches UPDATE_CONTACTMESSAGE actions', async () => {
      const arg = { id: 6827 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTMESSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTACTMESSAGE actions', async () => {
      const arg = 42666;
