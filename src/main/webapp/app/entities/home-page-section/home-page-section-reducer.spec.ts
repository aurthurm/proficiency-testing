...
import reducer, {
  ...
  reset,
  updateEntity,
} from './home-page-section.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOMEPAGESECTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HOMEPAGESECTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HOMEPAGESECTION actions', async () => {
      const arg = { id: 32425 };
    ...
    it('dispatches UPDATE_HOMEPAGESECTION actions', async () => {
      const arg = { id: 32425 };
    ...
    it('dispatches PARTIAL_UPDATE_HOMEPAGESECTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HOMEPAGESECTION actions', async () => {
      const arg = 42666;
