...
import reducer, {
  ...
  reset,
  updateEntity,
} from './participant-message.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICIPANTMESSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARTICIPANTMESSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARTICIPANTMESSAGE actions', async () => {
      const arg = { id: 8814 };
    ...
    it('dispatches UPDATE_PARTICIPANTMESSAGE actions', async () => {
      const arg = { id: 8814 };
    ...
    it('dispatches PARTIAL_UPDATE_PARTICIPANTMESSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARTICIPANTMESSAGE actions', async () => {
      const arg = 42666;
