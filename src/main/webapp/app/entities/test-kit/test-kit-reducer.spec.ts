...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './test-kit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTKIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TESTKIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TESTKIT actions', async () => {
      const arg = { id: 2063 };
    ...
    it('dispatches UPDATE_TESTKIT actions', async () => {
      const arg = { id: 2063 };
    ...
    it('dispatches PARTIAL_UPDATE_TESTKIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TESTKIT actions', async () => {
      const arg = 42666;
