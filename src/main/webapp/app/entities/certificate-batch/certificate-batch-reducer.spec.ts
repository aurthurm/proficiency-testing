...
import reducer, {
  ...
  reset,
  updateEntity,
} from './certificate-batch.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CERTIFICATEBATCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CERTIFICATEBATCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CERTIFICATEBATCH actions', async () => {
      const arg = { id: 8990 };
    ...
    it('dispatches UPDATE_CERTIFICATEBATCH actions', async () => {
      const arg = { id: 8990 };
    ...
    it('dispatches PARTIAL_UPDATE_CERTIFICATEBATCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CERTIFICATEBATCH actions', async () => {
      const arg = 42666;
