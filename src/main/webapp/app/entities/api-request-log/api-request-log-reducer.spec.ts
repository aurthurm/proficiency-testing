...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIREQUESTLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APIREQUESTLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APIREQUESTLOG actions', async () => {
      const arg = { id: 22349 };
    ...
    it('dispatches UPDATE_APIREQUESTLOG actions', async () => {
      const arg = { id: 22349 };
    ...
    it('dispatches PARTIAL_UPDATE_APIREQUESTLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APIREQUESTLOG actions', async () => {
      const arg = 42666;
