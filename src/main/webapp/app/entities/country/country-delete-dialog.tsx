...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="proficiencyTestingApp.country.delete.question">
        <Translate contentKey="proficiencyTestingApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
