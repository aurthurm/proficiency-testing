...
import reducer, {
  ...
  reset,
  updateEntity,
} from './shipment-participant-map.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIPMENTPARTICIPANTMAP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SHIPMENTPARTICIPANTMAP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SHIPMENTPARTICIPANTMAP actions', async () => {
      const arg = { id: 28545 };
    ...
    it('dispatches UPDATE_SHIPMENTPARTICIPANTMAP actions', async () => {
      const arg = { id: 28545 };
    ...
    it('dispatches PARTIAL_UPDATE_SHIPMENTPARTICIPANTMAP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SHIPMENTPARTICIPANTMAP actions', async () => {
      const arg = 42666;
