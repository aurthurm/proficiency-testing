...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODEOFRECEIPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MODEOFRECEIPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MODEOFRECEIPT actions', async () => {
      const arg = { id: 15338 };
    ...
    it('dispatches UPDATE_MODEOFRECEIPT actions', async () => {
      const arg = { id: 15338 };
    ...
    it('dispatches PARTIAL_UPDATE_MODEOFRECEIPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MODEOFRECEIPT actions', async () => {
      const arg = 42666;
