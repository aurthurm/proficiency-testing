...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './assay.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSAY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASSAY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASSAY actions', async () => {
      const arg = { id: 2555 };
    ...
    it('dispatches UPDATE_ASSAY actions', async () => {
      const arg = { id: 2555 };
    ...
    it('dispatches PARTIAL_UPDATE_ASSAY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASSAY actions', async () => {
      const arg = 42666;
