...
import reducer, {
  ...
  reset,
  updateEntity,
} from './scheme-configuration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEMECONFIGURATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHEMECONFIGURATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHEMECONFIGURATION actions', async () => {
      const arg = { id: 1742 };
    ...
    it('dispatches UPDATE_SCHEMECONFIGURATION actions', async () => {
      const arg = { id: 1742 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHEMECONFIGURATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHEMECONFIGURATION actions', async () => {
      const arg = 42666;
