...
import reducer, {
  ...
  reset,
  updateEntity,
} from './participant-custom-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICIPANTCUSTOMVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARTICIPANTCUSTOMVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARTICIPANTCUSTOMVALUE actions', async () => {
      const arg = { id: 14671 };
    ...
    it('dispatches UPDATE_PARTICIPANTCUSTOMVALUE actions', async () => {
      const arg = { id: 14671 };
    ...
    it('dispatches PARTIAL_UPDATE_PARTICIPANTCUSTOMVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARTICIPANTCUSTOMVALUE actions', async () => {
      const arg = 42666;
