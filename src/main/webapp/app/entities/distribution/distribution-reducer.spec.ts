...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISTRIBUTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISTRIBUTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISTRIBUTION actions', async () => {
      const arg = { id: 19959 };
    ...
    it('dispatches UPDATE_DISTRIBUTION actions', async () => {
      const arg = { id: 19959 };
    ...
    it('dispatches PARTIAL_UPDATE_DISTRIBUTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISTRIBUTION actions', async () => {
      const arg = 42666;
