...
import reducer, {
  ...
  reset,
  updateEntity,
} from './not-tested-reason.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTTESTEDREASON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTTESTEDREASON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTTESTEDREASON actions', async () => {
      const arg = { id: 24849 };
    ...
    it('dispatches UPDATE_NOTTESTEDREASON actions', async () => {
      const arg = { id: 24849 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTTESTEDREASON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTTESTEDREASON actions', async () => {
      const arg = 42666;
