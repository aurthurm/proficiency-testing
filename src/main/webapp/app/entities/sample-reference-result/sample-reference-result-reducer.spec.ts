...
import reducer, {
  ...
  reset,
  updateEntity,
} from './sample-reference-result.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SAMPLEREFERENCERESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SAMPLEREFERENCERESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SAMPLEREFERENCERESULT actions', async () => {
      const arg = { id: 890 };
    ...
    it('dispatches UPDATE_SAMPLEREFERENCERESULT actions', async () => {
      const arg = { id: 890 };
    ...
    it('dispatches PARTIAL_UPDATE_SAMPLEREFERENCERESULT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SAMPLEREFERENCERESULT actions', async () => {
      const arg = 42666;
