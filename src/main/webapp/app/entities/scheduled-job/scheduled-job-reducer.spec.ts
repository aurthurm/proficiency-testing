...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULEDJOB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHEDULEDJOB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHEDULEDJOB actions', async () => {
      const arg = { id: 8697 };
    ...
    it('dispatches UPDATE_SCHEDULEDJOB actions', async () => {
      const arg = { id: 8697 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULEDJOB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHEDULEDJOB actions', async () => {
      const arg = 42666;
