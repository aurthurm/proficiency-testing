...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATAMANAGER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DATAMANAGER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DATAMANAGER actions', async () => {
      const arg = { id: 7113 };
    ...
    it('dispatches UPDATE_DATAMANAGER actions', async () => {
      const arg = { id: 7113 };
    ...
    it('dispatches PARTIAL_UPDATE_DATAMANAGER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DATAMANAGER actions', async () => {
      const arg = 42666;
