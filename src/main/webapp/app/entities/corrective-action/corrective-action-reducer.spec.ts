...
import reducer, {
  ...
  reset,
  updateEntity,
} from './corrective-action.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CORRECTIVEACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CORRECTIVEACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CORRECTIVEACTION actions', async () => {
      const arg = { id: 25330 };
    ...
    it('dispatches UPDATE_CORRECTIVEACTION actions', async () => {
      const arg = { id: 25330 };
    ...
    it('dispatches PARTIAL_UPDATE_CORRECTIVEACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CORRECTIVEACTION actions', async () => {
      const arg = 42666;
