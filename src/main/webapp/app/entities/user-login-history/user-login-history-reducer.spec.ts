...
import reducer, {
  ...
  reset,
  updateEntity,
} from './user-login-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERLOGINHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERLOGINHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERLOGINHISTORY actions', async () => {
      const arg = { id: 21184 };
    ...
    it('dispatches UPDATE_USERLOGINHISTORY actions', async () => {
      const arg = { id: 21184 };
    ...
    it('dispatches PARTIAL_UPDATE_USERLOGINHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERLOGINHISTORY actions', async () => {
      const arg = 42666;
