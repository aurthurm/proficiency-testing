...
import reducer, {
  ...
  reset,
  updateEntity,
} from './participant-feedback.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICIPANTFEEDBACK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARTICIPANTFEEDBACK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARTICIPANTFEEDBACK actions', async () => {
      const arg = { id: 24282 };
    ...
    it('dispatches UPDATE_PARTICIPANTFEEDBACK actions', async () => {
      const arg = { id: 24282 };
    ...
    it('dispatches PARTIAL_UPDATE_PARTICIPANTFEEDBACK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARTICIPANTFEEDBACK actions', async () => {
      const arg = 42666;
