WITH promoted AS (
    ...
    SELECT
        ...
        a.payload::jsonb ->> 'name',
        a.payload::jsonb ->> 'value',
        'Migrated from legacy global_config'
    FROM legacy_record_archive a
    WHERE a.source_table = 'global_config' AND a.last_seen_batch_id = :batchId
...
SELECT 'global_config', config_key, 'global_configuration', id, :batchId, CURRENT_TIMESTAMP FROM promoted
