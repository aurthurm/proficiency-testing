...
| Distributions / shipments / enrollment                                              | `ShipmentController.php` (~90 actions), full lifecycle incl. deadlines, testkit assignment                      | CRUD scaffold on `Distribution`/`Shipment`/`ShipmentParticipantMap`/`Enrollment`, no workflow                    | **High** — split into 6 independently-testable subtasks (3.0–3.6)                                                                                                                | 3                         |
...
- [ ] Status state-machine per 3.0's documented spec (pending → ... → evaluated → reports generated → finalized, plus cancellation) — implement only the transitions 3.0 confirmed are real, not a guessed superset.
...
### 3.6 TB-form generation (scope decision deferred to 3.0)

- [ ] Once 3.0 determines whether this is shipment-workflow or report-generation, implement it in the correct phase (here, or move to Phase 6) — don't build it twice or leave it homeless.
...
Update this table as phases complete. Link each phase's detailed implementation plan (`docs/superpowers/plans/...`) once written.

| Phase                                                                            | Status      | Detailed plan |
| -------------------------------------------------------------------------------- | ----------- | ------------- |
| 0.1 — Role model & authorization                                                 | Not started | —             |
| 0.2 — Background job / scheduling infrastructure                                 | Not started | —             |
| 0.3 — Email / notification infrastructure                                        | Not started | —             |
| 0.4 — File storage integration                                                   | Not started | —             |
| 0.5 — API design for two clients                                                 | Not started | —             |
| 1 — Reference data & configuration                                               | Not started | —             |
| 2 — Participants & data managers                                                 | Not started | —             |
| 3.0 — Shipments.php deep-read (prerequisite)                                     | Not started | —             |
| 3.1 — Distributions                                                              | Not started | —             |
| 3.2 — Enrollment                                                                 | Not started | —             |
| 3.3 — Shipment core lifecycle                                                    | Not started | —             |
| 3.4 — Shipment-participant mapping & testkit assignment                          | Not started | —             |
| 3.5 — Deadline automation                                                        | Not started | —             |
| 3.6 — TB-form generation                                                         | Not started | —             |
| 4 — Result entry (9 active schemes)                                              | Not started | —             |
| 5 — Scoring / evaluation engine (9 active schemes, DTS = updated-3-tests + RTRI) | Not started | —             |
| 6 — Certificates & reports                                                       | Not started | —             |
| 7 — Notifications & scheduled jobs                                               | Not started | —             |
| 8 — Ancillary modules & dashboards                                               | Not started | —             |
| 9 — Mobile API finalization & cutover                                            | Not started | —             |
